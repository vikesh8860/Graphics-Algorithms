...
double t[20],angle=(M_PI*2)/180;
void one(point a,point b,point c,point d,int i,int j,int p1,int p2);
int backface_detection(point a,point b,point c,point d,int i);
void rotate_about_z()
{
...
{
    outtextxy(250,350,"FRONT VIEW");
    //draw the front view of the cube
    if(backface_detection(p[0],p[1],p[2],p[3],1))
    {
     line(150+p[0].x,250-p[0].y,150+p[1].x,250-p[1].y);
     line(150+p[1].x,250-p[1].y,150+p[2].x,250-p[2].y);
     line(150+p[2].x,250-p[2].y,150+p[3].x,250-p[3].y);
     line(150+p[3].x,250-p[3].y,150+p[0].x,250-p[0].y);
     one(p[0],p[1],p[2],p[3],1, 1,150,250);
    }
    if(backface_detection(p[4],p[7],p[6],p[5],1))
    {
      line(150+p[4].x,250-p[4].y,150+p[5].x,250-p[5].y);
      line(150+p[5].x,250-p[5].y,150+p[6].x,250-p[6].y);
      line(150+p[6].x,250-p[6].y,150+p[7].x,250-p[7].y);
      line(150+p[7].x,250-p[7].y,150+p[4].x,250-p[4].y);
      one(p[4],p[5],p[6],p[7],6, 1,150,250);
    }

    if(backface_detection(p[7],p[3],p[2],p[6],1))
    {

        line(150+p[6].x,250-p[6].y,150+p[7].x,250-p[7].y);
        line(150+p[2].x,250-p[2].y,150+p[3].x,250-p[3].y);
        line(150+p[2].x,250-p[2].y,150+p[6].x,250-p[6].y);
        line(150+p[3].x,250-p[3].y,150+p[7].x,250-p[7].y);
        one(p[6],p[7],p[2],p[3],5, 1,150,250);
    }
    if(backface_detection(p[4],p[5],p[1],p[0],1))
    {
        line(150+p[4].x,250-p[4].y,150+p[5].x,250-p[5].y);
        line(150+p[0].x,250-p[0].y,150+p[1].x,250-p[1].y);
        line(150+p[0].x,250-p[0].y,150+p[4].x,250-p[4].y);
        line(150+p[1].x,250-p[1].y,150+p[5].x,250-p[5].y);
        one(p[4],p[5],p[1],p[0],2, 1,150,250);
    }
    if(backface_detection(p[7],p[4],p[0],p[3],1))
    {
        line(150+p[7].x,250-p[7].y,150+p[4].x,250-p[4].y);
        line(150+p[3].x,250-p[3].y,150+p[7].x,250-p[7].y);
        line(150+p[0].x,250-p[0].y,150+p[4].x,250-p[4].y);
        line(150+p[3].x,250-p[3].y,150+p[0].x,250-p[0].y);
        one(p[7],p[4],p[0],p[3],3, 1,150,250);
    }
    if(backface_detection(p[6],p[2],p[1],p[5],1))
    {
        line(150+p[5].x,250-p[5].y,150+p[6].x,250-p[6].y);
        line(150+p[1].x,250-p[1].y,150+p[5].x,250-p[5].y);
        line(150+p[2].x,250-p[2].y,150+p[6].x,250-p[6].y);
        line(150+p[1].x,250-p[1].y,150+p[2].x,250-p[2].y);
        one(p[6],p[5],p[1],p[2],4, 1,150,250);
    }
}
void draw_cube_top()
{
    outtextxy(700,200,"TOP VIEW");
    if(backface_detection(p[0],p[1],p[2],p[3],3))
    {
     line(550+p[0].x,200-p[0].z,550+p[1].x,200-p[1].z);
     line(550+p[1].x,200-p[1].z,550+p[2].x,200-p[2].z);
     line(550+p[2].x,200-p[2].z,550+p[3].x,200-p[3].z);
     line(550+p[3].x,200-p[3].z,550+p[0].x,200-p[0].z);
     one(p[0],p[1],p[2],p[3],1, 2,550,200);
    }
    if(backface_detection(p[4],p[7],p[6],p[5],3))
    {
      line(550+p[4].x,200-p[4].z,550+p[5].x,200-p[5].z);
      line(550+p[5].x,200-p[5].z,550+p[6].x,200-p[6].z);
      line(550+p[6].x,200-p[6].z,550+p[7].x,200-p[7].z);
      line(550+p[7].x,200-p[7].z,550+p[4].x,200-p[4].z);
      one(p[4],p[5],p[6],p[7],6, 2,550,200);
    }

    if(backface_detection(p[7],p[3],p[2],p[6],3))
    {

        line(550+p[6].x,200-p[6].z,550+p[7].x,200-p[7].z);
        line(550+p[2].x,200-p[2].z,550+p[3].x,200-p[3].z);
        line(550+p[2].x,200-p[2].z,550+p[6].x,200-p[6].z);
        line(550+p[3].x,200-p[3].z,550+p[7].x,200-p[7].z);
        one(p[6],p[7],p[2],p[3],5, 2,550,200);
    }
    if(backface_detection(p[4],p[5],p[1],p[0],3))
    {
        line(550+p[4].x,200-p[4].z,550+p[5].x,200-p[5].z);
        line(550+p[0].x,200-p[0].z,550+p[1].x,200-p[1].z);
        line(550+p[0].x,200-p[0].z,550+p[4].x,200-p[4].z);
        line(550+p[1].x,200-p[1].z,550+p[5].x,200-p[5].z);
        one(p[4],p[5],p[1],p[0],2, 2,550,200);
    }
    if(backface_detection(p[7],p[4],p[0],p[3],3))
    {
        line(550+p[7].x,200-p[7].z,550+p[4].x,200-p[4].z);
        line(550+p[3].x,200-p[3].z,550+p[7].x,200-p[7].z);
        line(550+p[0].x,200-p[0].z,550+p[4].x,200-p[4].z);
        line(550+p[3].x,200-p[3].z,550+p[0].x,200-p[0].z);
        one(p[7],p[4],p[0],p[3],3, 2,550,200);
    }
    if(backface_detection(p[6],p[2],p[1],p[5],3))
    {
        line(550+p[5].x,200-p[5].z,550+p[6].x,200-p[6].z);
        line(550+p[1].x,200-p[1].z,550+p[5].x,200-p[5].z);
        line(550+p[2].x,200-p[2].z,550+p[6].x,200-p[6].z);
        line(550+p[1].x,200-p[1].z,550+p[2].x,200-p[2].z);
        one(p[6],p[5],p[1],p[2],4, 2,550,200);
    }
}
void draw_cube_side()
{
    outtextxy(700,650,"SIDE VIEW");
    if(backface_detection(p[0],p[1],p[2],p[3],2))
    {
     line(550+p[0].z,550-p[0].y,550+p[1].z,550-p[1].y);
     line(550+p[1].z,550-p[1].y,550+p[2].z,550-p[2].y);
     line(550+p[2].z,550-p[2].y,550+p[3].z,550-p[3].y);
     line(550+p[3].z,550-p[3].y,550+p[0].z,550-p[0].y);
     one(p[0],p[1],p[2],p[3],1, 3,550,550);
    }
    if(backface_detection(p[4],p[7],p[6],p[5],2))
    {
      line(550+p[4].z,550-p[4].y,550+p[5].z,550-p[5].y);
      line(550+p[5].z,550-p[5].y,550+p[6].z,550-p[6].y);
      line(550+p[6].z,550-p[6].y,550+p[7].z,550-p[7].y);
      line(550+p[7].z,550-p[7].y,550+p[4].z,550-p[4].y);
      one(p[4],p[5],p[6],p[7],6, 3,550,550);
    }

    if(backface_detection(p[7],p[3],p[2],p[6],2))
    {

        line(550+p[6].z,550-p[6].y,550+p[7].z,550-p[7].y);
        line(550+p[2].z,550-p[2].y,550+p[3].z,550-p[3].y);
        line(550+p[2].z,550-p[2].y,550+p[6].z,550-p[6].y);
        line(550+p[3].z,550-p[3].y,550+p[7].z,550-p[7].y);
        one(p[6],p[7],p[2],p[3],5, 3,550,550);
    }
    if(backface_detection(p[4],p[5],p[1],p[0],2))
    {
        line(550+p[4].z,550-p[4].y,550+p[5].z,550-p[5].y);
        line(550+p[0].z,550-p[0].y,550+p[1].z,550-p[1].y);
        line(550+p[0].z,550-p[0].y,550+p[4].z,550-p[4].y);
        line(550+p[1].z,550-p[1].y,550+p[5].z,550-p[5].y);
        one(p[4],p[5],p[1],p[0],2, 3,550,550);
    }
    if(backface_detection(p[7],p[4],p[0],p[3],2))
    {
        line(550+p[7].z,550-p[7].y,550+p[4].z,550-p[4].y);
        line(550+p[3].z,550-p[3].y,550+p[7].z,550-p[7].y);
        line(550+p[0].z,550-p[0].y,550+p[4].z,550-p[4].y);
        line(550+p[3].z,550-p[3].y,550+p[0].z,550-p[0].y);
        one(p[7],p[4],p[0],p[3],3, 3,550,550);
    }
    if(backface_detection(p[6],p[2],p[1],p[5],2))
    {
        line(550+p[5].z,550-p[5].y,550+p[6].z,550-p[6].y);
        line(550+p[1].z,550-p[1].y,550+p[5].z,550-p[5].y);
        line(550+p[2].z,550-p[2].y,550+p[6].z,550-p[6].y);
        line(550+p[1].z,550-p[1].y,550+p[2].z,550-p[2].y);
        one(p[6],p[5],p[1],p[2],4, 3,550,550);
    }
...
void initial()
{
    p[0].z=0; p[0].y=0; p[0].z=0;     p[1].x=80; p[1].y=0;  p[1].z=0;    p[2].x=80;p[2].y=0;p[2].z=80;       p[3].x=0;p[3].y=0;p[3].z=80;
...
void one(point a,point b,point c,point d,int i,int j,int p1,int p2)
{
    ...
    {
        line(p1+(int)xwn,p2-(int)ywn,p1+(int)xen,p2-(int)yen);
        line(p1+(int)xwn,p2-(int)ywn,p1+(int)xws,p2-(int)yws);
        line(p1+(int)xws,p2-(int)yws,p1+(int)xes,p2-(int)yes);
    }
    else
    {
...
int backface_detection(point a,point b,point c,point d,int i)
{
    ...
    if(i==1)  //for front view
    {
        cen.x-=40;
        cen.y-=40;
        cen.z-=100000;
    }
    else if(i==2)  //for side view
    {
        cen.x-=100000;
        cen.y-=40;
        cen.z-=40;
    ...
    if((cen.x*p3.x+cen.y*p3.y+cen.z*p3.z)<=0)   //return true for visible
        return 1;
    return 0;
}
